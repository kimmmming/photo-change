...
import { DownloadIcon, SparklesIcon, SpinnerIcon } from './components/Icons';
import { RefinePanel } from './components/RefinePanel';
import { swapCharactersInImage } from './services/geminiService';
            ...
            {!isLoading && resultImage && (
              <div className="w-full flex flex-col items-center gap-6">
                  ...
                  <a
                    ...
                    className="flex items-center justify-center gap-2 mt-4 px-5 py-3 font-semibold text-white bg-green-600 rounded-xl shadow-md transition-all duration-300 hover:bg-green-700 hover:scale-105"
                  >
                    <DownloadIcon />
                    Download Image
                  </a>
